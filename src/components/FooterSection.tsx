import capitanoImg from "@/assets/capitano.jpg";
    ...
    <footer className="bg-primary text-primary-foreground">
      ...
      <div className="px-6 md:px-12 py-6 flex flex-col md:flex-row items-start md:items-center justify-between border-b border-primary-foreground/10">
        <div className="flex gap-6">
          ...
          <span className="font-display text-xs tracking-widest text-primary-foreground/70">CATALOGUE</span>
          <span className="font-display text-xs tracking-widest text-primary-foreground/70">COLLECTION</span>
        </div>
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <span className="font-display text-xs tracking-widest text-primary-foreground/70">INSTAGRAM</span>
          <div className="relative rounded-lg overflow-hidden">
            <img src={capitanoImg} alt="Player of the week" loading="lazy" width={512} height={640} className="w-40 h-48 object-cover img-grayscale" />
            <div className="absolute inset-0 bg-primary/30" />
            <div className="absolute bottom-3 left-3 right-3">
              <h4 className="font-display text-lg font-bold text-primary-foreground leading-tight">EL CAPITANO "USA"</h4>
              <span className="font-display text-[10px] tracking-widest text-primary-foreground/60 bg-primary-foreground/10 px-2 py-0.5 rounded mt-1 inline-block">PLAYER OF THE WEEK</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 py-8">
        <div className="flex flex-col md:flex-row justify-between gap-6 mb-10">
          <div>
            <h4 className="font-display text-lg font-bold text-primary-foreground">OFFSIDE</h4>
